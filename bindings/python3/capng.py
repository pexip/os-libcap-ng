...
def capng_updatev(action: "capng_act_t", type: "capng_type_t", capability: "unsigned int", capability1: "int"=0, capability2: "int"=0, capability3: "int"=0, capability4: "int"=0, capability5: "int"=0, capability6: "int"=0, capability7: "int"=0, capability8: "int"=0, capability9: "int"=0, capability10: "int"=0, capability11: "int"=0, capability12: "int"=0, capability13: "int"=0, capability14: "int"=0, capability15: "int"=0, capability16: "int"=0) -> "int":
